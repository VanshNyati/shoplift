...
router.post('/:userId', validateBody(cartAddSchema), asyncHandler(async (req: Request, res: Response) => {
  const { userId } = req.params;
...
router.put('/:userId/:productId', validateBody(cartQtySchema), asyncHandler(async (req: Request, res: Response) => {
...
router.delete('/:userId/:productId', asyncHandler(async (req: Request, res: Response) => {
  const { userId, productId } = req.params;
